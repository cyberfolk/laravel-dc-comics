...
<div class="container">
    ...
    <form action="{{route('admin.comics.update', $comic->id)}}" method="post">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="description" id="description" class="form-control" placeholder="Comic description here" value="{{$comic->description}}" aria-describedby="descriptionHelper">
